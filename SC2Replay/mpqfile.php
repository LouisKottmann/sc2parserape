...
//See line 745 to uncomment the area (switch bzip2 decompression to a C# library)
//import namespace System;
//import namespace System:::IO;
//import namespace ICSharpCode;
...
class MPQFile {
	...
	static function readByte(&$string, &$numByte) {
        ...
        //echo "$Counter numByte in: $numByte ";
		$tmp = unpack("C",substr($string,$numByte,1));
		$numByte++;
        //echo "numByte out: $numByte, result: $tmp[1]\n"; 
		return $tmp[1];
	}
	...
	function bzip2_decompress($string) {
		if (function_exists("bzdecompress")){
            ...
            //$inStream = new MemoryStream($string);
            //BZip2::Decompress($inStream, $outStream, true);
            //$tempDecompress = $outStream->ToArray();
            //$tmp = $tempDecompress;
